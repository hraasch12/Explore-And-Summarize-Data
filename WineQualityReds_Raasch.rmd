...
The majority of the wines are of average quality (4-5) and there are few wines 
with low or high quality. The lowest quality is 3 and the highest quality is 8. 
...
We see that a higher concentration of the darker dots are located on the left 
side of the plot. This indicates the higher quality wines. This is also where 
we see the larger dots representing the wines with a higher alcohol content. 
...
Here we see the higher quality wines represented by the darker lines. We see 
they lay close to the center of the plot. 
...
wines. We see the higher quality wines represented by the blue and pink colors. 
The highest density of those colors tends to be in the center of each of the 
plots. 

We also see a majority of the dots on the plot are green and blue. This 
